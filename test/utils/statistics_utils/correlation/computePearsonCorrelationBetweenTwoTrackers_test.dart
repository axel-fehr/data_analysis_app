...
import 'package:tracking_app/utils/statistics_utils/correlation.dart'
    show computePearsonCorrelationBetweenTwoTrackers;
...
void main() {
  test(
    ...
    () async {
      ...
      expect(
          () => computePearsonCorrelationBetweenTwoTrackers(tracker1, tracker2),
          throwsArgumentError);
      expect(
          () => computePearsonCorrelationBetweenTwoTrackers(tracker2, tracker1),
          throwsArgumentError);
